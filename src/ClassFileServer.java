...
public class ClassFileServer extends ClassServer {
    ...
    private static String 	raiz = "/home/ssimonsc/universidade/seguridade/servidor/Keys/";
    ...
    private static ServerSocketFactory getServerSocketFactory(String type) {
        ...
        if (type.equals("TLS"))
        {
            ...
            try {
                ...
                KeyStore 			ks;
                char[] 				contraseña = "nosoContrasinal".toCharArray();

                ctx = SSLContext.getInstance("TLS");
                kmf = KeyManagerFactory.getInstance("SunX509");

                ks  = KeyStore.getInstance("JCEKS");
                ks.load(new FileInputStream(raiz + "serverKey.jce"), contraseña);
    ...
    private static void definirKeyStores()
    {
        ...
        System.setProperty("javax.net.ssl.keyStore",         raiz + "serverKey.jce");
